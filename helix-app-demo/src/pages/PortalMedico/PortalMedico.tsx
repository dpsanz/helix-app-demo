...
import { getUser, initials, listDoctorPatients, updateUser } from '../../data/helixDb'
...
export default function PortalMedico() {
  ...
  return <div className="app-shell medical page-enter">
    ...
    <main className="dashboard">
      ...
      <section className="profile-hero"><div className="avatar">{initials(doctor.name)}</div><div><span className="eyebrow">Médico cooperado</span><h1>{doctor.name}</h1><p>CRM-SP 85442 · Cardiologia</p></div><span className="status-ok">● Cadastro validado</span></section>
